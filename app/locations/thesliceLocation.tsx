...
export default function thesliceLocation() {

    return (
        <SafeAreaView style={styles.container}>
            <Link href="/locations/whichwichLocation" style={styles.navBack}>Back</Link>

            <Link href="/locations/thepubLocation" style={styles.navForward}>Next</Link>
