...
export default function zenLocation() {

    return (
        <SafeAreaView style={styles.container}>
            <Link href="/chickfilaLocation" style={styles.navBack}>Back</Link>

            <Link href="/locations/whichwichLocation" style={styles.navForward}>Next</Link>
