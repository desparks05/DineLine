...
export default function thepubLocation() {

    return (
        <SafeAreaView style={styles.container}>
            <Link href="/locations/thesliceLocation" style={styles.navBack}>Back</Link>

            <Link href="/locations/moesLocation" style={styles.navForward}>Next</Link>
