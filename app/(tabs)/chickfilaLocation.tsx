...
export default function chickfilaLocation() {

    return (
        <SafeAreaView style={styles.container}>
            <Link href="/locations/moesLocation" style={styles.navBack}>Back</Link>

            <Link href="/locations/zenLocation" style={styles.navForward}>Next</Link>
